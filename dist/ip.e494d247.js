...
function bayrakOlustur(data) {
  ...
  lat.textContent = "Enlem: ".concat(data.enlem, " Boylam: ").concat(data.boylam);
  var city = document.createElement("p");
  city.textContent = "\u015Eehir: ".concat(data.şehir);
  var timezone = document.createElement("p");
  timezone.textContent = "Saat dilimi: ".concat(data.saatdilimi);
  var currency = document.createElement("p");
  currency.textContent = "Para birimi: ".concat(data.parabirimi);
